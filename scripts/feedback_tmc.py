    ...
    for team in teams: 
        ...
        with open(this_out, 'w') as out:
            ...
            for i, df_row in this_data.iterrows():
                # try encoding utf8
                this_comment=df_row['teamcomments'].encode('utf-8','ignore').decode('utf-8')
        ...
        with open(this_out, 'w') as out:
            ...
            for i, df_row in this_data.iterrows():
                # try encoding utf8
                this_comment=df_row['confidentialcomments'].encode('utf-8','ignore').decode('utf-8')
                if ( this_comment == "nan"):
                    print("### " + df_row['username'] + "Team member {-}\n\nNo comments\n\n", file=out)
                else:
                    print("### " + df_row['username'] + " (Team member){-}\n\n" + this_comment + "\n\n", file=out)
        ...
        # convert to pdf
        output = pypandoc.convert_file(this_out, to='md', format='md', outputfile=this_out, extra_args=pdoc_args)
